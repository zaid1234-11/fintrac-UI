    ...
    >
      ...
      <div className="fintrac-dark-glass-card p-8 rounded-[32px] relative z-10 flex flex-col gap-8 border border-white/10">
        {allocatableGoals.map(goal => {
          ...
          return (
            <div key={goal.id} className="flex flex-col gap-4 pb-6 border-b border-white/5 last:border-0 last:pb-0">
              ...
              {/* Slider Track */}
              <div className="relative h-2 w-full bg-white/10 rounded-full cursor-pointer group flex items-center">
                <input 
                  type="range"
                  min="0"
                  max={maxPossible}
