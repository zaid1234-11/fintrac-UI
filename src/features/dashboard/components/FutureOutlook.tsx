...
export function FutureOutlook({ forecast }: { forecast: ForecastObject | null }) {
  ...
  return (
    ...
    >
      ...
      <LiquidCard level={2} className="p-8 md:p-10 relative overflow-hidden group transition-all rounded-[32px]">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 md:gap-6 p-2 rounded-[24px] bg-white/5 border border-white/10 relative z-10">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-white/10 relative z-10">
